...
\begin{tabular}{c|c|c|c|c|c|c|c|c}
        ...
        \end{tabular}
  \caption{A table showcasing the result of the abstract property transformer $\times_\pm$ which is an abstraction of the concrete multiplication operator.}\label{table:properties}
  \end{center}
\end{table}
...
Table \ref{table:intervalarithmetics} shows the supported 
...
\begin{tabular}{l|l}
        ...
        \end{tabular}
  \caption{Supported abstract operations for the  implemented interval domain.}\label{table:intervalabstractoperations}
  \end{center}
\end{table}
\endgroup
