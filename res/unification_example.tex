...
\noindent This leaves no empty bounds, meaning we can proceed with step \ref{item:traverse}. We examine the first bound of each FunArray. Since \texttt{\string{0,i\string}} $\cup$ \texttt{\string{0\string}} $\neq\emptyset$
