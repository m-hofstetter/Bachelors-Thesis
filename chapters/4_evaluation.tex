...
\begin{enumerate}
	\item The general case, where at least one array in a state contains a segment without an unknown value.
	\item The more narrow case where at least one array is two or more segments and one of these has a value that is not unknown.
\end{enumerate}
